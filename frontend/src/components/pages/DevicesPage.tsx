    ...
    <div className="flex flex-col gap-6">
      ...
      <DeviceFormDialog
        ...
        initial={editTarget ? {
          ...
          model_manual: editTarget.model_manual,
          ...
          hostname: editTarget.hostname ?? '', hostname_manual: editTarget.hostname_manual,
          uptime: editTarget.uptime ?? '',
          multi_vsys: editTarget.multi_vsys ?? '', multi_vsys_manual: editTarget.multi_vsys_manual,
          serial_number: editTarget.serial_number ?? '', serial_number_manual: editTarget.serial_number_manual,
          os_name: editTarget.os_name ?? '',
          os_version: editTarget.os_version ?? '', os_version_manual: editTarget.os_version_manual,
