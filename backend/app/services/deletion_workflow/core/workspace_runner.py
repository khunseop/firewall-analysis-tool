...
class WorkspaceRunner:
    ...
    def run_task(
        ...
        **extra_kwargs,
        ...
        """
        # TemporaryDirectory 대신 mkdtemp + 명시적 cleanup 사용.
        # Windows에서 TemporaryDirectory.__exit__ → shutil.rmtree 중
        # xlsx 파일 락(WinError 267/5)이 전파되는 것을 방지한다.
        ...
        try:
            ...
            # ignore_errors=True: Windows 파일 락으로 삭제 실패해도 예외 전파 안 함
