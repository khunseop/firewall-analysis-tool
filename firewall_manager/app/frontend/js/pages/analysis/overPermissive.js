 ...
 */
export function initOverPermissiveAnalysis(select) {
    deviceSelect = select;
}
 ...
 */
export async function loadPoliciesForOverPermissive() {
    ...
    try {
        ...
        // 대상 정책 선택 초기화
        const targetSelectEl = document.getElementById('over-permissive-target-policy-select');
        ...
        console.error('Failed to load policies for over-permissive analysis:', err);
 ...
 */
export function getOverPermissiveAnalysisParams() {
